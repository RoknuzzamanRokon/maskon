...
export default function WhatsAppChat({
  ...
  const whatsappNumber = "+8801739933258";
  ...
  return (
    <>
      ...
      {!isOpen && (
        <motion.button
          className={`fixed bottom-6 right-6 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center z-50 group ${className}`}
      ...
      {isOpen && (
        <motion.div
          className="fixed bottom-6 right-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 w-80"
            ...
            <div className="space-y-3">
              ...
              <div className="text-center">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Available: Mon-Fri 9AM-6PM (GMT+6)
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400">
