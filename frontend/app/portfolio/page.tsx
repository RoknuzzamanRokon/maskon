  ...
  const teamMembers = [
    {
      ...
      bio: "Passionate about creating seamless digital experiences with cutting-edge technologies. Specialized in React and modern web development.",
      skills: ["Python", "FastAPI", "TypeScript", "React", "Next.js"],
